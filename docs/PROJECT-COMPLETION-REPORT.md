...
|------|-----------------|-------------------|
| Catalogue and browsing | FR-01 to FR-11 | Implemented; final Epic 1 contract proof remains TASK-29 |
| Rental calculator | FR-12 to FR-17 | Implemented; final Epic 1 contract proof remains TASK-29 |
...
| Must | Final Epic 1 API contract tests | Lets Epic 1 Jira items move to Done with evidence | TASK-29 |
...
4. Complete TASK-30.
5. Complete TASK-23.
6. Run `dotnet build ReviewPortal.slnx`.
7. Run `dotnet test ReviewPortal.slnx`.
8. Run secret scan and package vulnerability scan.
9. Verify local and Azure database migration state.
10. Run Azure smoke tests and CORS checks.
11. Attach final test/dry-run/usability screenshots and logs to the submission pack.
...
The project is ready for 100 percent final sign-off only after TASK-29, TASK-30, TASK-23, security scan cleanup, Azure credential rotation, Azure smoke testing, and final test evidence are complete.
