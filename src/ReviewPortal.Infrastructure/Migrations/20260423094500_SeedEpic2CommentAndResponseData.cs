...
[Migration("20260423094500_SeedEpic2CommentAndResponseData")]
public partial class SeedEpic2CommentAndResponseData : Migration
{
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            """
            DELETE FROM dbo.CompanyResponses
            WHERE Id BETWEEN 6001 AND 6002;

            DELETE FROM dbo.ReviewComments
            WHERE Id BETWEEN 5001 AND 5004;
            """);
    }
}
